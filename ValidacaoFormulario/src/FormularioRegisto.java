...
public class FormularioRegisto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ctxMorada.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        ctxTelefone.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        ctxNif.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        ctxLogin.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        ctxPass.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        ctxRePass.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(ctxLogin, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nome.equals("") || email.equals("") || morada.equals("") 
                || telefone.equals("") || nif.equals("") || login.equals("")
        ...
        for(int x=0; x<login.length();x++){
            ...
            if(c==' '){
                mensagemErro("O campo login não pode conter espaços");
                break;
            }
        }
        ...
        if(nome.length()<6){
            mensagemErro("O campo nome tem de conter nome completo");
        }else{
            int espacos = 0;
